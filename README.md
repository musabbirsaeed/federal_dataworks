...
3. Push changes to the `main` branch, or run the **Publish GitHub Pages** workflow manually from the **Actions** tab.
...
The workflow validates the static site, uploads the `public/` directory as the Pages artifact, and deploys it to GitHub Pages. No local web server is required.

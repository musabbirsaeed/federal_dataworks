...
The workflow validates the static site on pull requests and pushes. For pushes to `main` or manual dispatches, it uploads the `public/` directory as the Pages artifact and deploys it to GitHub Pages. No local web server is required.
